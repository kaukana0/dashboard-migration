...
mv  components/eclLikeSelect/dropdownBox.mjs    components/eclLikeSelect/dropdownBox.js
mv  components/eclLikeSelect/markUpCode.mjs    components/eclLikeSelect/markUpCode.js
...
mv  js/view/modules/dropDowns/dropDowns.mjs    js/view/modules/dropDowns/dropDowns.js
mv  js/view/modules/dropDowns/logic.mjs    js/view/modules/dropDowns/logic.js
...
sed -i 's/\.mjs/\.js/'  ./components/eclLikeSelect/dropdownBox.js
...
sed -i 's/\.mjs/\.js/'  ./js/view/modules/dropDowns/dropDowns.js
