...
mv ./components/chartCard/functionalities/verticalLines.mjs   ./components/chartCard/functionalities/verticalLines.js
mv ./components/chartCard/functionalities/multilineFocus.mjs   ./components/chartCard/functionalities/multilineFocus.js
